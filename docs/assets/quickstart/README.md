...
- `viewer.png`: browser screenshot of the actual DA3-CAD viewer, showing the separate `photo-cad-book-vlm3-v1` DA3 draft. Source photos are omitted from this viewer. No successful acceptance is implied.
